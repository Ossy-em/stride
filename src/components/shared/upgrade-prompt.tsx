...
const REASON_CONFIG = {
  session_limit: {
    icon: <Zap className="w-6 h-6 text-[#8aa89c]" />,
  ...
  self_discovery: {
    icon: <BarChart3 className="w-6 h-6 text-[#8aa89c]" />,
  ...
  ai_insights: {
    icon: <Brain className="w-6 h-6 text-[#8aa89c]" />,
  ...
  history: {
    icon: <Download className="w-6 h-6 text-[#8aa89c]" />,
...
export default function UpgradePrompt({ reason, onClose, context }: UpgradePromptProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#10221c]/50 backdrop-blur-sm">
      <div className="w-full max-w-sm bg-white rounded-2xl shadow-xl overflow-hidden">
        {/* Header */}
        <div className="relative bg-[#10221c] p-6 pb-8">
          <button
            onClick={onClose}
          ...
          <p className="text-sm text-[#8aa89c] mt-2">{config.description}</p>
        </div>

        {/* Premium benefits */}
        <div className="p-6">
          <p className="text-xs font-medium text-[#7c9389] mb-3">
            Premium includes
          </p>
          <div className="space-y-2.5">
            {[
              ...
              <div key={benefit} className="flex items-center gap-2.5">
                <div className="w-4 h-4 rounded-full bg-[#eef1ed] flex items-center justify-center flex-shrink-0">
                  <div className="w-1.5 h-1.5 rounded-full bg-[#10221c]" />
                </div>
                <span className="text-sm text-[#48645b]">{benefit}</span>
              </div>
            ))}
          </div>
          ...
          <button
            ...
            className="w-full mt-6 py-3 bg-[#10221c] text-[#f0f0ec] font-medium rounded-xl hover:bg-[#1a3229] transition-colors"
          >
            Upgrade to Premium
          </button>
          <button
            onClick={onClose}
            className="w-full mt-2 py-2 text-sm text-[#7c9389] hover:text-[#10221c] transition-colors"
          >
            Maybe later
          </button>
        </div>
